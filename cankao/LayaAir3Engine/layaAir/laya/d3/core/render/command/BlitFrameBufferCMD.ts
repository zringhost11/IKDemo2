...
export class BlitFrameBufferCMD {
    private static readonly _pool = Pool.createPool(BlitFrameBufferCMD);
    ...
    static create(source: BaseTexture, dest: RenderTexture, viewport: Viewport, offsetScale: Vector4 = null, shader: Shader3D = null, shaderData: ShaderData = null, subShader: number = 0) {
        ...
        cmd = BlitFrameBufferCMD._pool.take();
        cmd._source = source;
        cmd._dest = dest;
    ...
    run(): void {
        ...
        shaderData.setVector(Command.SCREENTEXTUREOFFSETSCALE_ID, this._offsetScale || _defaultOffsetScale);
     ...
     */
    recover(): void {
        BlitFrameBufferCMD._pool.recover(this);
        this._source = null;
        this._dest = null;
