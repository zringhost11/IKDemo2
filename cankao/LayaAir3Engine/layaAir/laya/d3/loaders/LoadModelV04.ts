...
export class LoadModelV04 {
    ...
    static parse(readData: Byte, version: string, mesh: Mesh, subMeshes: SubMesh[]): void {
        ...
        for (var i: number = 0, n: number = LoadModelV04._BLOCK.count; i < n; i++) {
            ...
            var index: number = LoadModelV04._readData.readUint16();
    ...
    private static _readString(): string {
        return LoadModelV04._strings[LoadModelV04._readData.readUint16()];
    }
    ...
    private static READ_DATA(): void {
        LoadModelV04._DATA.offset = LoadModelV04._readData.readUint32();
        LoadModelV04._DATA.size = LoadModelV04._readData.readUint32();
    }
    ...
    private static READ_BLOCK(): void {
        var count: number = LoadModelV04._BLOCK.count = LoadModelV04._readData.readUint16();
        var blockStarts: any[] = LoadModelV04._BLOCK.blockStarts = [];
        var blockLengths: any[] = LoadModelV04._BLOCK.blockLengths = [];
        for (var i: number = 0; i < count; i++) {
            blockStarts.push(LoadModelV04._readData.readUint32());
            blockLengths.push(LoadModelV04._readData.readUint32());
        }
    }
    ...
    private static READ_STRINGS(): void {
        var offset: number = LoadModelV04._readData.readUint32();
        var count: number = LoadModelV04._readData.readUint16();
    ...
    private static READ_MESH(): boolean {
        ...
        var arrayBuffer: ArrayBuffer = LoadModelV04._readData.rawBuffer;
        var i: number;

        var memorySize: number = 0;
        var vertexBufferCount: number = LoadModelV04._readData.readInt16();
        var offset: number = LoadModelV04._DATA.offset;
        for (i = 0; i < vertexBufferCount; i++) {//TODO:始终为1
            var vbStart: number = offset + LoadModelV04._readData.readUint32();
            var vbLength: number = LoadModelV04._readData.readUint32();
        ...
        var ibStart: number = offset + LoadModelV04._readData.readUint32();
        var ibLength: number = LoadModelV04._readData.readUint32();
        ...
        var boneCount: number = LoadModelV04._readData.readUint16();
        boneNames.length = boneCount;
        for (i = 0; i < boneCount; i++)
            boneNames[i] = LoadModelV04._strings[LoadModelV04._readData.readUint16()];

        LoadModelV04._readData.pos += 8;//TODO:优化

        var bindPoseDataStart: number = LoadModelV04._readData.readUint32();
        var bindPoseDataLength: number = LoadModelV04._readData.readUint32();
    ...
    private static READ_SUBMESH(): boolean {
        ...
        LoadModelV04._readData.readInt16();//TODO:vbIndex
        LoadModelV04._readData.readUint32();//TODO:vbStart
        LoadModelV04._readData.readUint32();//TODO:vbLength

        var ibStart: number = LoadModelV04._readData.readUint32();
        var ibCount: number = LoadModelV04._readData.readUint32();
        ...
        var drawCount: number = LoadModelV04._readData.readUint16();
        ...
        for (var i: number = 0; i < drawCount; i++) {
            subIndexBufferStart[i] = LoadModelV04._readData.readUint32();
            subIndexBufferCount[i] = LoadModelV04._readData.readUint32();
            var boneDicofs: number = LoadModelV04._readData.readUint32();
            var boneDicCount: number = LoadModelV04._readData.readUint32();
